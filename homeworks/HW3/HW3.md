# Lab 8: Explainability with Alibi
...
Complete all the Deliverables mentioned below and include evidence/answers in your report.

## Deliverables
- Finish all the TODOs in Section 2. Include evidence of completion in your report. 
- Generate PD Plots. Explain your findings about model performance in the report, and then answer Q1, Q2, and Q3:
     ...
     - Q3: What the heatmaps results show in the results?  (Section 2.2)
- Show final results about the Anchor parameters and discuss them in your report.
- Attach the completed explainability.ipynb in your submission. 

## Getting Started
Clone [this](https://github.com/pedrogbmendes/mlip-explainability-lab) repository and follow instructions in the notebook. 

<b>Please ignore the language in the ipynb about discussing/explaining to a TA. Instead, you have to write a report and explain/discuss the results in your report!</b>
...
<br><br>
If there's any more issues, please contact the TA to update this list (with a solution if its solved)
